...
> Teniendo en cuenta lo anterior, diseña un gráfico tipo 'journey' en una caja de código mermaid.js que represente el flujo de usuario para dicho modelo de negocio. Considera el paradigma de las 5A's de Philip Kotler el cual describe las etapas clave del viaje del comprador en la era digital (Atención, Atracción, Averiguación, Acción y Apología). Es imperativo guiarte por el siguiente modelo de código mermaid.js. Debes representar los tres roles o actores involucrados en cada paso del flujo usuario sistema y otros. Sin embargo, adicionalmente debes indicar de forma clara el actor dominante en cada fase del journey asignándole el mayor valor dentro de cada sección. Asegúrate de que en cada sección exista coherencia entre las acciones y el actor dominante, de manera que este tenga mayor peso en la interacción principal de esa etapa. NO incluir caracteres especiales en la salida, como por ejemplo: (|_->=-<#´'):
journey
